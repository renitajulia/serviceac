        ...
        <div class="row">
            <div class="col-md-12">
                <?php foreach ($prodfeature as $produk) { ?>
                    <?= form_open_multipart('daftar_produk/pembayaran/' . $produk->kode_produk); ?>
                            ...
                            <div class="caption">
                                ...
                                <center>
                                    <table class="table table-stripped" align="center">
                                        <input type="hidden" name="id_produk" value="<?= $produk->kode_produk; ?>">
                                        <tr>
                                            <th nowrap>Harga </th>
                                        ...
                                        <tr>
                                            ...
                                            <?php foreach ($user as $u) { ?>
                                                <td><input type="text" class="form-control" name="alamat" value="<?= $u->no_telp; ?>"></td>
                                            <?php } ?>
                                        </tr>
                                    </table>
                                </center>
